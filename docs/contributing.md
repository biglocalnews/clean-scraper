...
Our project welcomes new contributors who want to help us fix bugs and improve our scrapers. The current status of our effort is documented in our [issue tracker](https://github.com/biglocalnews/clean-scraper/issues).
...
When coding a new scraper, the there are a few important conventions to follow:
...
Below is pared down version of San Diego's [Site](https://github.com/biglocalnews/clean-scraper/blob/main/clean/ca/san_diego_pd.py) class to illustrate these conventions.

``` python
# clean/ca/san_diego_pd.py
