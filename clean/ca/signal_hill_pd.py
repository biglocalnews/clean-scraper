...
class Site:
    """Scrape file metadata for the Signal Hill Police Department.
    ...
    def __init__(
        ...
        """
        self.site_slug = "ca_signal_hill_pd"
        self.base_url = "https://www.muckrock.com/foi/signal-hill-3448/2023-sb1421sb16-request-signal-hill-police-department-140449"  # Embargoed
    ...
    def scrape_meta(self, throttle: int = 2) -> Path:
        ...
        """
        to_be_scraped: Dict = {
            "https://www.muckrock.com/foi/signal-hill-3448/2023-sb1421sb16-request-signal-hill-police-department-140449": True,
        }
