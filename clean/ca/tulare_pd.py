...
class Site:
    """Scrape file metadata for the Tulare Police Department.
    ...
    def __init__(
        ...
        """
        self.site_slug = "ca_tulare_pd"
        self.base_url = (
            "https://www.muckrock.com/foi/tulare-3477/sb1421-records-85929"  # Embargoed
        )
    ...
    def scrape_meta(self, throttle: int = 2) -> Path:
        ...
        """
        to_be_scraped: Dict = {
            "https://www.muckrock.com/foi/tulare-3477/sb1421-records-85929": True,
            "https://www.muckrock.com/foi/tulare-3477/2023-sb1421sb16-request-tulare-police-department-139456": True,
        }
