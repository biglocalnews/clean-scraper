...
class Site:
    """Scrape file metadata for the Ukiah Police Department.
    ...
    def __init__(
        ...
        """
        self.site_slug = "ca_ukiah_pd"
        self.base_url = "https://www.muckrock.com/foi/ukiah-3482/sb1421-records-2022-123212"  # Embargoed
    ...
    def scrape_meta(self, throttle: int = 2) -> Path:
        ...
        """
        to_be_scraped: Dict = {
            "https://www.muckrock.com/foi/ukiah-3482/sb1421-records-2022-123212": True,
            "https://www.muckrock.com/foi/ukiah-3482/ukiah-police-department-2024-sb1421sb16-request-164552": True,
        }
