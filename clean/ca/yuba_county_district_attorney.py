...
class Site:
    """Scrape file metadata for the Yuba County District Attorney.
    ...
    def __init__(
        ...
        """
        self.site_slug = "ca_yuba_county_district_attorney"
        self.base_url = "https://www.muckrock.com/foi/yuba-county-3079/sb1421-records-2022-122620"  # Embargoed
    ...
    def scrape_meta(self, throttle: int = 2) -> Path:
        ...
        """
        to_be_scraped: Dict = {
            "https://www.muckrock.com/foi/yuba-county-3079/sb1421-records-2022-122620": True,
        }
