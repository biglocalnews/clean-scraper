...
class Site:
    """Scrape file metadata for the Salinas Police Department.
    ...
    def __init__(
        ...
        """
        self.site_slug = "ca_salinas_pd"
        self.base_url = "https://www.muckrock.com/foi/salinas-3409/2023-sb1421sb16-request-salinas-police-department-138649"  # Embargoed
    ...
    def scrape_meta(self, throttle: int = 2) -> Path:
        ...
        """
        to_be_scraped: Dict = {
            "https://www.muckrock.com/foi/salinas-3409/2023-sb1421sb16-request-salinas-police-department-138649": True,
            "https://www.muckrock.com/foi/salinas-3409/sb1421-records-2022-123075": True,
            "www.muckrock.com/foi/salinas-3409/salinas-police-department-2024-sb1421sb16-request-164544": True,
        }
