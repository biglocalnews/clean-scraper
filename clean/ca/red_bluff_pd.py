...
class Site:
    """Scrape file metadata for the Red Bluff Police Department.
    ...
    def __init__(
        ...
        """
        self.site_slug = "ca_red_bluff_pd"
        self.base_url = "https://www.muckrock.com/foi/red-bluff-3390/sb1421-records-2022-123046"  # Embargoed
    ...
    def scrape_meta(self, throttle: int = 2) -> Path:
        ...
        """
        to_be_scraped: Dict = {
            "https://www.muckrock.com/foi/red-bluff-3390/sb1421-records-2022-123046": True,
            "https://www.muckrock.com/foi/red-bluff-3390/red-bluff-police-department-2024-sb1421sb16-request-164541": True,
        }
